...
'Alumno': 'Alumno',
'Alumnos': 'Alumnos',
'Alumnos(created_by)': 'Alumnos(created_by)',
'Alumnos(modified_by)': 'Alumnos(modified_by)',
...
'Apoderados(apoderados)': 'Apoderados(apoderados)',
'Apoderados(created_by)': 'Apoderados(created_by)',
'Apoderados(modified_by)': 'Apoderados(modified_by)',
'Apoderados(usuario)': 'Apoderados(usuario)',
'appadmin': 'appadmin',
...
'Deuda': 'Deuda',
'Deudas': 'Deudas',
'Deudas(created_by)': 'Deudas(created_by)',
'Deudas(modified_by)': 'Deudas(modified_by)',
'DISK': 'DISCO',
'Disk Cache Keys': 'Llaves de Caché en Disco',
'Disk Cleared': 'Disco limpiado',
'Documentation': 'Documentación',
'Documento pagos': 'Documento pagos',
'Documento pagos(created_by)': 'Documento pagos(created_by)',
'Documento pagos(modified_by)': 'Documento pagos(modified_by)',
...
'not in': 'no en',
'Número de cuotas': 'Número de cuotas',
...
'Pago': 'Pago',
'Pago archives': 'Pago archives',
'Pago archives(created_by)': 'Pago archives(created_by)',
'Pago archives(modified_by)': 'Pago archives(modified_by)',
'Pagos': 'Pagos',
'Pagos(created_by)': 'Pagos(created_by)',
'Pagos(modified_by)': 'Pagos(modified_by)',
'Password': 'Contraseña',
